    ...
    <script>
        function select_single(file) {
            ...
            reader.onload = function (evt) {
                ...
                // 再将获取值赋给img标签
                $('#img-single').attr("src", replaceSrc);
            };
...
<div style="margin-bottom: 10px;">
    <span class="publish-name">${u.name}&nbsp;&nbsp;发布闲置&nbsp;&nbsp;上传物品主体图片</span>
</div>
...
<div class="publish-bottom">
    <form id="form_1" action="forepublish" method="post" style="width: 450px; display: inline-block;">
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" id="name" name="name" readonly="readonly" value="${i.name}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" id="categoryName" name="categoryName" readonly="readonly" value="${c.name}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" id="originalPrice" name="originalPrice" readonly="readonly"
        ...
        <div class="row">
            ...
            <div class="col-75">
                <input type="text" id="salePrice" name="salePrice" readonly="readonly" value="${i.salePrice}">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-75">
                <textarea id="description" name="description" style="height: 150px;"
                          readonly="readonly">${i.description}</textarea>
            </div>
        </div>
    </form>

    <form id="form_2" action="forepublishImage?uid=${u.id}" method="post" enctype="multipart/form-data"
